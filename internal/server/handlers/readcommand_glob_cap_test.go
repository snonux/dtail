...
// All turbo/aggregate/lifecycle methods are stubs. The catLimiter is
...
func (s *globCapTestServer) RegisterAggregateLines(_ chan *line.Line) {}
func (s *globCapTestServer) SharedLinesChannel() chan *line.Line       { return s.lines }
func (s *globCapTestServer) HasRegularAggregate() bool                 { return false }
func (s *globCapTestServer) TurboAggregate() *maprserver.TurboAggregate { return nil }
...
func (s *globCapTestServer) TurboBoostDisabled() bool              { return true }
func (s *globCapTestServer) IsTurboMode() bool                     { return false }
func (s *globCapTestServer) EnableTurboMode()                      {}
func (s *globCapTestServer) HasTurboEOF() bool                     { return false }
func (s *globCapTestServer) FlushTurboData()                       {}
func (s *globCapTestServer) SignalTurboEOF()                       {}
func (s *globCapTestServer) GetTurboChannel() chan []byte           { return nil }
func (s *globCapTestServer) TurboChannelLen() int                  { return 0 }
func (s *globCapTestServer) WaitForTurboEOFAck(time.Duration) bool { return true }
...
func (s *globCapTestServer) AggregateLinesChannelBufferSize() int      { return 4 }
func (s *globCapTestServer) TurboDataTransmissionDelay() time.Duration { return time.Millisecond }
func (s *globCapTestServer) TurboEOFWaitDuration(int) time.Duration    { return time.Millisecond }
func (s *globCapTestServer) ShutdownTurboSerializeWait() time.Duration { return time.Millisecond }
func (s *globCapTestServer) ShutdownIdleRecheckWait() time.Duration    { return time.Millisecond }
func (s *globCapTestServer) TurboEOFAckTimeout() time.Duration         { return time.Millisecond }
