...
func (s *panicAggregateServer) Aggregate() *maprserver.Aggregate { return s.aggregate }
...
func TestReadViaProcessorClosesAggregateProcessorAfterReaderPanic(t *testing.T) {
	aggregate, err := maprserver.NewAggregate("select count($0) from .", "", logging.NopLogger{})
	if err != nil {
